...
export async function GET() {
    try {
        ...
        // Promote admin@admin.com if it exists
        console.log("- Promoting admin@admin.com...")
        try {
            ...
            console.log("  (Failed to promote admin@admin.com)")
        }
        ...
        return NextResponse.json({ success: true, message: "Etihad AlRaeda Seed Successful!" })
    } catch (error: any) {
